...
export default function SignUp() {
  return (
    <div className="min-h-screen bg-white flex">
      <Head>
        <title>Get started with N0lan</title>
      </Head>
            ...
            <dl className="mt-8 space-y-10">
              {figFunctions.map((figFunction) => (
                <div key={figFunction.name} className="relative">
                  ...
                  <dd className="mt-1 ml-12 text-base text-gray-500">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 gap-8 lg:grid-cols-3">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image src={logo1} height={60} width={159} />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image src={logo2} height={60} width={159} />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image src={logo3} height={60} width={159} />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="mt-6">
              <form action="#" method="POST" className="space-y-6">
                ...
                <Link href="/signin" passHref>
                  <button
                    type="button"
                    className="w-full flex justify-center text-sm text-primary hover:text-primary-active"
                  >
