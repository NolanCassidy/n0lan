...
const LandingPage: NextPage = () => (
  <>
    <Head>
      <title>N0lan: Your Intelligent Coding Companion</title>
      <meta
        property="og:title"
        content="N0lan: Your Intelligent Coding Companion"
      />
      <meta
        property="og:description"
        content="Reading and writing code is hard! N0lan helps you interpret the details so you can focus on building what matters"
      />
      <meta property="og:type" content="website" />
      <meta property="og:image" content="https://n0lan.com/thumbnail.png" />
      <meta property="og:url" content="https://n0lan.com" />
    </Head>
    <div className="relative bg-hero overflow-hidden">
      <Header />
      <div
        className="hidden sm:block sm:absolute sm:inset-0 overflow-hidden z-0"
        aria-hidden="true"
      >
        <Image className="h-full w-full opacity-25" src={HeroBG} />
      </div>
              ...
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  ...
                  <p className="mt-3 text-base text-gray-300 sm:pr-4 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Reading and writing code is hard! N0lan helps you interpret
                    the details so you can focus on building what matters
                  </p>
                </div>
              </div>
                ...
                <div className="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
                  <div className="px-4 py-8 sm:px-10">
                    ...
                    <div className="mt-6">
                      <form action="#" method="POST" className="space-y-6">
                        <div>
                          <p className="sr-only">Full name</p>
                          <input
                            type="text"
                            name="name"
                            id="name"
                  ...
                  <div className="px-4 py-6 bg-gray-50 border-t-2 border-gray-200 sm:px-10">
                    <p className="text-xs leading-5 text-gray-500">
                      ...
                      <Link
                        href="https://app.termly.io/document/terms-of-use-for-saas/45b03409-3c40-49ee-aa05-ba71a4cbdf5b"
                        passHref
                      >
                        <button
                          type="button"
                      ...
                      ,{" "}
                      <Link
                        href="https://app.termly.io/document/privacy-policy/d2126d4e-53aa-4527-ab2e-bb39b6b8e2ad"
                        passHref
                      >
                        <button
                          type="button"
                      ...
                      and{" "}
                      <Link
                        href="https://app.termly.io/document/cookie-policy/830638a7-2d92-4b18-a52a-b1d4f100e931"
                        passHref
                      >
                        <button
                          type="button"
      ...
      <div className="relative bg-white py-16 overflow-hidden">
        <div className="mt-8 mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
          ...
          <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
            Powered by AI and trained with billions of lines of code, N0lan
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Having trouble understanding the program that you&apos;re
                    looking at? Use the{" "}
                    <span className="py-px px-1 bg-gray-100 rounded-md text-primary font-medium">
                      Explain Code
                    </span>{" "}
                ...
                <blockquote>
                  <div>
                    <p className="text-base text-gray-500">
                      &ldquo;What I really need is something that explains other
                      devs&apos; code. I just tried some of my functions in the
                      Explain Code tool and was blown away. Bravo.&rdquo;
                    </p>
                  </div>
            ...
            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-10 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-3">
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Need to convert Python to Go or Ruby to Javascript? The{" "}
                    <span className="py-px px-1 bg-gray-100 rounded-md text-primary font-medium">
                      Language Translator
                    </span>{" "}
                    function lets you reliably swap from one language to
                    another.
                  </p>
                  <div className="mt-6">
                    <Link href="/api/auth/login" passHref>
              ...
              <div className="mt-8 border-t border-gray-200 pt-6">
                <blockquote>
                  <div>
                    <p className="text-base text-gray-500">
                      &ldquo;Over the last decade when I&apos;ve been dabbling
                      in learning languages trying to understand the logic. This
                      is exactly the sort of tool to take that specific
                      challenge away.&rdquo;
                    </p>
                  </div>
                  <footer className="mt-3">
                    <div className="flex items-center space-x-3">
            ...
            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Don&apos;t like writing documentation for your functions?
                    Have N0lan&apos;s{" "}
                    <span className="py-px px-1 bg-gray-100 rounded-md text-primary font-medium">
                      Docstring Writer
                    </span>{" "}
                    craft detailed docstrings so your functions are always
              ...
              <div className="mt-8 border-t border-gray-200 pt-6">
                <blockquote>
                  <div>
                    <p className="text-base text-gray-500">
                      &ldquo;The docstring function blew me away. It writes what
                      the parameters are and what the function returns so I
                      don&apos;t have to.&rdquo;
                    </p>
                  </div>
                  <footer className="mt-3">
            ...
            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-3">
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Measure the efficiency of your code in Big O notation using
                    the{" "}
                    <span className="py-px px-1 bg-gray-100 rounded-md text-primary font-medium">
                      Time Complexity
                    </span>{" "}
              ...
              <div className="mt-8 border-t border-gray-200 pt-6">
                <blockquote>
                  <div>
                    <p className="text-base text-gray-500">
                      &ldquo;Love each of the value-props, the time complexity
                      tracker was especially slick.&rdquo;
                    </p>
                  </div>
                  <footer className="mt-3">
                    <div className="flex items-center space-x-3">
