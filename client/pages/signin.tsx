            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-primary focus:ring-primary-active border-gray-300 rounded cursor-pointer"
                />
                <h1 className="ml-2 block text-sm text-gray-900">
                  Remember me
                </h1>
              </div>
